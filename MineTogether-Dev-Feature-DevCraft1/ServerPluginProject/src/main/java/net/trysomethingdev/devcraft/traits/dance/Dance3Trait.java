package net.trysomethingdev.devcraft.traits.dance;
...
//The Trait class also implements Listener so you can add EventHandlers directly to your trait.
    @TraitName("dance3trait")
    public class Dance3Trait extends Trait {
    ...
    public Dance3Trait() {
        ...
        int maxSize = 10;
    public Dance3Trait(int length, int width, int depth) {
        super("dance3trait");
    ...
    // Here you should load up any values you have previously saved (optional).
        ...
        public void click(net.citizensnpcs.api.event.NPCRightClickEvent event){
            ...
            {
               Bukkit.getLogger().info("NPC CLICKED ON - Dance 3");
                Bukkit.getLogger().info("Hello Chat");
                NPCJump();
            }
        }
